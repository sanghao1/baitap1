...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">ATN CONPANY</a></h1>
</div>
<!--close-Header-part--> 
  ...
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Product Operator</span> <span class="label label-important">3</span></a>
      <ul>
        ...
        <li><a href="?action=list_products">List Products</a></li>
        <li><a href="#">Edit</a></li>
      </ul>
    </li>
      ...
      <div class="span12">
        <div class="widget-box">  
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>          
           <a href="?action=add_new_category"> <button type="button" class="btn btn-default" style="margin-top:2px;">Add new</button>
            </a>
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr class="odd gradeX">
                  ...
                  <td><a href="?action=edit_category&categoryid=<?php echo $value['categoryid'];?>">Edit</a></td>
                  <td><a href="?action=delete_category&categoryid=<?php echo $value['categoryid'];?>">Delete</a></td>
                </tr>
              <?php endforeach; ?>
